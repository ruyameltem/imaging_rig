#image count, experiment time and sleep time should be set.
...
##experiment time after servo goes down
EXPERIMENT_TIME = 12 #normally 8

#servo duty cycle according to 180C
DISTANCE = 12

#servo movement
IS_SERVO_MOVED = 2

#down time of the servo
...
#image count
#set exact count for your experiment
...
def record():
    ...
    for frameData in names:
        ...
        filename = "/home/pi/Desktop/Ruya/" + frameData[0] + ".jpeg"
    ...
    '''
    with file as open('/home/pi/Desktop/Ruya/'+datetime.utcnow().strftime('%Y-%m-%d-%H:%M:%S.%f')+'.txt','w'):
        file.write(results)
    '''
...
def after_record():
    ...
    #Sleep time for servo to the top
    sleep(36) #normally 28
